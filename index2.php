...
$koneksi = mysqli_connect("localhost", "root", "", "movewell");
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') { // Menampilkan Semua Data TO DO: Buat lebih spesifik (Untuk POSTMAN)
    ...
    $sql = "INSERT INTO produk (nama_produk, model_produk, harga_produk, deskripsi_produk) VALUES ('$nama_produk', '$model_produk', '$harga_produk', '$deskripsi_produk')";
    ...
    $model_produk = $_PUT['model_produk_update'];
    $harga_produk = $_PUT['harga_produk_update'];
    $deskripsi_produk = $_PUT['deskripsi_produk_update'];

    $sql = "UPDATE produk SET nama_produk='$nama_produk', model_produk='$model_produk', harga_produk='$harga_produk', deskripsi_produk='$deskripsi_produk' WHERE id_produk='$id_produk'";
    $cek = mysqli_query($koneksi, $sql);
